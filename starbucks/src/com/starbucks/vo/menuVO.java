...
public class menuVO {
	...
	public void setIntro_t(String intro_t) {
		this.intro_t = intro_t;
	}
	public String getIntro_b() {
		return intro_b;
	}
	public void setIntro_b(String intro_b) {
		this.intro_b = intro_b;
	}
	public String getNutri_inform() {
		return nutri_inform;
	}
	public void setNutri_inform(String nutri_inform) {
		this.nutri_inform = nutri_inform;
	}
